            ...
            <div className="TileContainer">
                ...
                <div className="Tile">
                    ...
                    <div className="Tile-Details">
                        ...
                        <div className="ProjectInfo">
                            <h3 className="ProjectInfo-Title"> React Logo Generator </h3>
                            <p className="ProjectInfo-Description">This is Play Area to Change to generate React Logo with different colors This is Play Area to Change to generate React Logo with different colors</p>
                        </div><div className="AuthorInfo">
                            <a href="https://github.com/pankajladhar" target="_blank">
                                <img className="AuthorInfo-Avatar" src="https://avatars2.githubusercontent.com/u/6375735?v=4" name="Pankaj Ladhar" />
                            </a>
